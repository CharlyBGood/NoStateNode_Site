    ...
    <div className="bg-black w-full max-w-xs m-auto">
      ...
      >
        ...
        <div className="mb-4">
          ...
          <input
            className="bg-transparent shadow-sm appearance-none border border-gray-700 rounded-sm w-full py-2 px-3 text-gray-700 leading-tight focus:outline-hidden focus:shadow-outline"
            type="email"
            name="email"
            id="email"
        ...
        <div className="mb-4">
          <p className="my-4 text-sm flex justify-between">
            <Link
              className="w-full py-1 outline-hidden hover:text-orange-200 border-none text-center font-bold border rounded-sm mb-2 "
              to="/login"
            >
              Volver a Inicio
            </Link>
